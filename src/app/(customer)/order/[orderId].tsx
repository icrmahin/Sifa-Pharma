...
const styles = StyleSheet.create({
  ...
  timelineLabel: { color: colors.text, fontSize: typography.bodySmall, fontWeight: '700' },
  timelineTime: { color: colors.textMuted, fontSize: typography.caption },
  timelineNote: { color: colors.textMuted, fontSize: typography.bodySmall, marginTop: spacing.xs },
});
