...
begin
  ...
  ('Paracetamol 500mg Tablets 20s', 'Panadol', 'Paracetamol', v_gsk, v_pain, 'Fast-acting pain and fever relief. 20 coated tablets. Suitable for headache, toothache and cold symptoms.', 250, 300, 17, 0, 'pack', null, null, true, true),
  ('Ibuprofen 400mg Tablets 20s', 'Brufen', 'Ibuprofen', v_bayer, v_pain, 'Non-steroidal anti-inflammatory for pain and inflammation. Take with food.', 320, null, 0, 0, 'pack', null, null, true, true),
  ('Amoxicillin 500mg Capsules 21s', 'Amoxil', 'Amoxicillin', v_gsk, v_abx, 'Broad-spectrum penicillin antibiotic. Complete the full course as prescribed.', 850, 1000, 15, 0, 'pack', null, null, true, false),
  ('Azithromycin 500mg Tablets 3s', 'Zithromax', 'Azithromycin', v_pfizer, v_abx, 'Macrolide antibiotic for respiratory and skin infections. 3-day course.', 650, null, 0, 0, 'pack', null, null, true, false),
  ('Vitamin C 1000mg Tablets 30s', 'Redoxon', 'Ascorbic Acid', v_bayer, v_vit, 'High-strength vitamin C with zinc for immune support.', 780, 950, 18, 0, 'pack', null, null, true, true),
  ('Multivitamin Syrup 200ml', 'Seven Seas', 'Multivitamin', v_cosmos, v_vit, 'Daily multivitamin syrup for adults. Contains vitamins A, D, E and B-complex.', 520, null, 0, 0, 'bottle', null, null, true, false),
  ('Metformin 500mg Tablets 60s', 'Glucophage', 'Metformin', v_novartis, v_diab, 'First-line treatment for type 2 diabetes. Take with meals.', 1200, 1350, 11, 0, 'pack', null, null, true, true),
  ('Lisinopril 10mg Tablets 28s', 'Zestril', 'Lisinopril', v_az, v_cardio, 'ACE inhibitor for hypertension and heart failure. Monitor blood pressure.', 980, null, 0, 0, 'pack', null, null, true, false),
  ('Amlodipine 5mg Tablets 30s', 'Norvasc', 'Amlodipine', v_pfizer, v_cardio, 'Calcium channel blocker for high blood pressure and angina.', 890, 1100, 19, 0, 'pack', null, null, true, false),
  ('Salbutamol Inhaler 100mcg 200 doses', 'Ventolin', 'Salbutamol', v_gsk, v_resp, 'Reliever inhaler for asthma and COPD. Shake well before use.', 1450, null, 0, 0, 'inhaler', null, null, true, true),
  ('Cetirizine 10mg Tablets 14s', 'Zyrtec', 'Cetirizine', v_bayer, v_resp, 'Non-drowsy antihistamine for allergies and hay fever.', 380, 450, 15, 0, 'pack', null, null, true, false),
  ...
  ('Povidone Iodine 100ml', 'Betadine', 'Povidone-Iodine', v_lab, v_aid, 'Antiseptic solution for wound cleaning and infection prevention.', 310, null, 0, 0, 'bottle', null, null, true, false),
  ...
  ('Paracetamol Syrup 100ml - Paediatric', 'Panadol Baby', 'Paracetamol', v_gsk, v_pain, 'Paediatric paracetamol syrup 120mg/5ml for fever and pain in children.', 290, null, 0, 0, 'bottle', null, null, true, false),
  ...
  ('Amox-Clav 625mg Tablets 14s', 'Augmentin', 'Amoxicillin Clavulanate', v_gsk, v_abx, 'Co-amoxiclav for resistant bacterial infections. Take at start of meal.', 1450, null, 0, 0, 'pack', null, null, true, false),
